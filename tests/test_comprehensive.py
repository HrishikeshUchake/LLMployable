...
class TestInputValidator:
    ...
    def test_valid_job_description(self):
        ...
        valid_desc = "We are looking for a software engineer with 5+ years of Python experience. " \
    ...
    def test_validate_complete_request(self):
        ...
        github = "torvalds"
        job_desc = "We are looking for a seasoned Python developer with 10+ years of experience " \
...
class TestGitHubScraper:
    ...
    def test_scrape_nonexistent_user(self, mock_github_class):
        ...
        mock_github_instance = Mock()
        mock_github_instance.get_user = Mock(side_effect=GithubException(404, {"message": "Not Found"}))
        mock_github_class.return_value = mock_github_instance
...
class TestFlaskApp:
    ...
    def test_generate_resume_endpoint(self, mock_compile, mock_generate, mock_analyze, 
                                      mock_scrape, client):
        """Test resume generation endpoint"""
        # Setup mocks
        mock_scrape.return_value = {'username': 'test', 'repositories': []}
        mock_analyze.return_value = {'skills': {}, 'experience_required': 'Not specified'}
        ...
        with patch('os.path.exists', return_value=True):
            with patch('builtins.open', create=True):
                response = client.post('/api/v1/generate-resume', 
                                      json={
