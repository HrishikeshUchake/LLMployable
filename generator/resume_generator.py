...
Only return valid JSON, no additional text."""
    ...
    def _format_projects(self, projects: List[Dict]) -> str:
        ...
        for proj in projects[:5]:
            formatted.append(f"- {proj['name']}: {proj['description']} ({proj['language']}, {proj['stars']} stars)")
    ...
    def _generate_basic_resume(self, profile_data: Dict, job_requirements: Dict) -> Dict:
