...
from mongoengine import (
    connect, disconnect, Document, StringField, EmailField, 
    URLField, IntField, FloatField, DateTimeField, ListField,
    EmbeddedDocument, EmbeddedDocumentField, DictField, BooleanField,
    CASCADE, DENY
)
...
class DatabaseManager:
    ...
    def connect(self):
        ...
        try:
            logger.info(f"Connecting to MongoDB at {config.DATABASE_HOST}:{config.DATABASE_PORT}")
            ...
            if config.DATABASE_USERNAME and config.DATABASE_PASSWORD:
                ...
                connection_string = (
                    f"mongodb://{config.DATABASE_HOST}:{config.DATABASE_PORT}/{config.DATABASE_NAME}"
                )
