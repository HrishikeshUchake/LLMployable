...
import { Github, Linkedin, Briefcase, Download, Loader2, Rocket, AlertCircle, CheckCircle2, Info } from 'lucide-react';
...
async function generateResumeAction(prevState: ActionState, formData: FormData): Promise<ActionState> {
  ...
  try {
    ...
    // Open preview in new tab instead of force downloading
          ...
          <div className="bg-indigo-600 rounded-[2rem] p-8 text-white shadow-xl shadow-indigo-100">
            ...
            <ul className="space-y-4 text-indigo-50 leading-relaxed text-sm font-medium">
              ...
              <li className="flex gap-3">
                ...
                Include context about the role and company culture.
              </li>
            </ul>
          </div>

          <div className="bg-white rounded-[2rem] p-8 border border-slate-100 shadow-lg">
            <h3 className="text-lg font-bold text-slate-800 mb-2">Data Privacy</h3>
            <p className="text-slate-500 text-sm leading-relaxed font-medium">
              We process your data securely. {user ? 'Your generated resumes are saved to your profile for easy access.' : 'Since you are not logged in, your data will not be saved.'}
            </p>
          </div>
        </motion.div>
      </div>
